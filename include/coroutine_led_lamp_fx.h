...
//
// db_signal.h: header file for co-working based on AceRoutine (https://github.com/bxparks/AceRoutine)
//
...
public:
    ...
    Coroutine_Led_Lamp_Fx(PIN_ID *pins_definition);
...
public:
    ...
    // Getters
    int pin_count;                              // number of wired to manage
